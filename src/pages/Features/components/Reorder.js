...
const Reorder = () => {
  ...
  return (
    <div className="mt-16" style={containerStyle}>
        ...
        <div className="mx-auto max-w-2xl py-0 sm:py-0 lg:max-w-none lg:py-6">
          <div className="mx-auto max-w-3xl sm:px-6 lg:grid lg:max-w-6xl lg:grid-cols-2 lg:gap-x-16 lg:px-16">
            ...
            <div className="group relative">
              <div className="relative h-80 mt-40 w-full overflow-hidden bg-white aspect-container">
                <div className="w-full h-full" style={{ overflow: 'hidden' }}>
                  <img
                    src="https://cdn.mrkhub.com/dochub-frontend/103/images/_pages/old-main/pictures/editor/controls.png"
                    alt="Example"
                    style={imageStyle}
                  />
                </div>
